...
class YearlyLeaveDashboardView(View):
    ...
    def get_leave_requests(self, year, department_id):
    ...
    def generate_name_colors(self, leave_requests):
        name_colors = {}
    ...
    def get(self, request):
        ...
        try:
            ...
            leave_requests = self.get_leave_requests(year, department_id)
            ...
            name_colors = self.generate_name_colors(leave_requests)
...
#         #This ensures that when current_message_index reaches the length of message_list, it will wrap around to 0 again, effectively creating a loop.
#         current_message_index = request.session.get('current_message_index', 0)
#         current_message = message_list[current_message_index % len(message_list)]
#         messages.info(request, current_message)
#         request.session['current_message_index'] = (current_message_index + 1) % len(message_list)
